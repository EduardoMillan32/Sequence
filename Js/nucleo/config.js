// Js/nucleo/config.js
// Firebase init + configuración de reglas + sistema de toasts
...
export function inicializarReglas(jugadoresTotales, equiposTotales) {
...
// También exponemos en window para compatibilidad con llamadas inline del HTML
